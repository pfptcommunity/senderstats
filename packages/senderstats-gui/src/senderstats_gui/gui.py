...
def get_version():
    try:
        return version("senderstats-gui")
...
def set_app_icon(root: tk.Tk):
    try:
        with resources.path("senderstats_gui.images", "senderstats.png") as p:
    ...
    if sys.platform.startswith("win"):
        try:
            with resources.path("senderstats_gui.images", "senderstats.ico") as p:
